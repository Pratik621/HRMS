// backend/utils/contractPolicy.js
// The default employees.contract_policy text stamped onto every new employee record —
// shown verbatim on their Profile > Contract tab. Must stay in sync with the copy in
// frontend/src/components/Admin/AddEmployee.jsx's DEFAULT_CONTRACT_POLICY (that one is used
// for the manual Add Employee flow; this one is used for offer-link/onboarding auto-created
// accounts) — they're duplicated rather than shared because frontend and backend are separate
// runtimes with no shared module boundary in this repo.
...
module.exports = { DEFAULT_CONTRACT_POLICY };
